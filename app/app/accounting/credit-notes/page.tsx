...
export default function CreditNotesPage() {
  ...
  return (
    <div className="p-6 lg:p-8 max-w-[1200px] mx-auto space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-foreground tracking-tight mb-1">Credit Notes</h1>
        <p className="text-sm text-muted-foreground">Create and track credit notes for invoice adjustments.</p>
      </div>
      ...
      <Card className="border border-border/50 overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody>
              {filtered.length === 0 ? <tr><td colSpan={5} className="px-4 py-8 text-center text-muted-foreground/60">No credit notes found.</td></tr> : filtered.map((note) => (
