  ...
  return (
    <div className="p-6 lg:p-8 max-w-[1200px] mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-0.5">Create and track credit notes for invoice adjustments</p>
      </div>
      ...
      <Card className="p-5 border border-primary/15 bg-primary/[0.02] space-y-3">
        <div className="flex items-center gap-2.5 mb-1">
          ...
          <div>
            ...
            <p className="text-[11px] text-muted-foreground/60">Issue a credit against an invoice</p>
          </div>
        </div>
        ...
        <div className="pt-3 border-t border-border/30">
          <Button size="sm" onClick={createCreditNote}>Save Credit Note</Button>
        </div>
      </Card>
